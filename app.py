...
if user_ingredients:
    ...
    def find_matching_recipes(user_ingredients, df):
        ...
        for _, row in df.iterrows():
            # Assuming 'ingredients' is a column with comma-separated ingredients in the CSV
            ...
            if match_count > 0:  # Only include recipes with at least one matching ingredient
                matching_recipes.append((row['recipe_name'], match_count, row['instructions']))
